...
export const projectData = [
...

  {
    ...
    /* ---------------- OVERVIEW ---------------- */
    overview:
      "This website redesign was created after client feedback on the initial design direction. The client felt that the earlier content and visual structure were not focused enough on ClubCash's core product and wanted the website to communicate its actual membership, NFC, payments, rewards, and EURC capabilities more clearly. Based on the client's revised content and requirements, I redesigned the website with a stronger product-focused structure, clearer messaging, improved visual hierarchy, and more engaging product visuals.",

    /* ---------------- ABOUT ---------------- */
    about:
      "ClubCash is a digital membership and payments platform designed for clubs, venues, organizations, members, and merchants. The platform brings membership management, NFC access, mobile wallets, payments, rewards, and EURC stablecoin payments into one connected experience. The redesign focused on presenting these core capabilities in a simple, modern, and visually engaging way while making the value of ClubCash easier to understand for different audiences.",

    /* ---------------- CLIENT FEEDBACK / DESIGN DIRECTION ---------------- */
    client_feedback:
      "The initial website direction did not fully match the client's product focus. The client provided new content and a clearer direction centered around ClubCash's actual platform capabilities. I used the revised content as the foundation for the redesign and restructured the page around the core product story, including digital membership, NFC, payments, EURC, rewards, organizations, and merchants. The updated visual direction was well received by the client.",

    /* ---------------- PROBLEM / SOLUTION ---------------- */
    problem_solution: [
      {
        problem:
          "The initial website content was not focused enough on ClubCash's core product and did not clearly communicate what the platform actually offers.",
        solution:
          "Redesigned the website around the client's revised content, focusing on digital membership, NFC access, payments, rewards, EURC payments, and the connected ClubCash ecosystem.",
      },
      {
        problem:
          "The client needed visitors to understand the ClubCash platform quickly without having to read large amounts of technical information.",
        solution:
          "Created a clear visual hierarchy with concise messaging, feature highlights, step-by-step platform explanations, and dedicated sections for the key ClubCash capabilities.",
      },
      {
        problem:
          "NFC and EURC payments are important parts of the ClubCash proposition but needed stronger visual communication.",
        solution:
          "Added dedicated visual sections for NFC digital membership and EURC payments, using product mockups, QR codes, mobile wallets, and payment visuals to make the concepts easier to understand.",
      },
      {
        problem:
          "ClubCash serves multiple audiences including members, organizations, and merchants, making it important to explain the platform from different perspectives.",
        solution:
          "Introduced a 'Three Connected Experiences' section that clearly presents the benefits and use cases for Members, Organizations, and Merchants.",
      },
      {
        problem:
          "The website needed to feel modern and trustworthy while communicating that ClubCash is more than a traditional membership card.",
        solution:
          "Added stronger product visuals, modern cards, platform dashboards, payment flows, trust-focused sections, and supporting imagery to create a polished and credible digital product experience.",
      },
    ],

    /* ---------------- KEY REDESIGN HIGHLIGHTS ---------------- */
    redesign_highlights: [
      "Reworked the homepage around the client's revised product-focused content.",
      "Made NFC and Digital Membership a prominent part of the user journey.",
      "Added a dedicated EURC Payments section to explain stablecoin-based payments visually.",
      "Created a clear Join → Tap → Pay → Rewards flow.",
      "Added separate experiences for Members, Organizations, and Merchants.",
      "Introduced product mockups and dashboard visuals to make the platform easier to understand.",
      "Improved visual hierarchy, spacing, content grouping, and CTA placement.",
      "Added trust, security, privacy, and modern payment infrastructure sections.",
    ],

    /* ---------------- VISUAL DESIGN ---------------- */
    visual_design:
      "The redesigned interface combines a clean white layout with ClubCash's signature green visual language. Product mockups, mobile wallet screens, NFC devices, QR codes, payment interfaces, dashboards, icons, and supporting imagery were added to make the product experience more tangible and engaging. The visual system was designed to keep complex platform features easy to scan and understand.",

    /* ---------------- BEFORE / AFTER ---------------- */
    custom_compare: {
      before: {
        heading:
          "Before – Initial Direction Not Fully Aligned With the Product",
        img: "clubcash/before.png",
      },
      after: {
        heading: "After – Product-Focused, Visual & Client-Approved Redesign",
        img: "clubcash/s1.png",
      },
    },
    ...
    /* ---------------- KEY SECTIONS ---------------- */
    key_sections: [
      "Digital Membership & Cashless Payments",
      "How ClubCash Works",
      "NFC & Digital Membership",
      "EURC Payments",
    ...
    /* ---------------- LESSONS LEARNED ---------------- */
    lesson_learned: [
      "Client feedback can reveal when a visual direction needs to be realigned with the actual product and business goals.",
      "Content and UI design need to work together so that the interface communicates the product clearly rather than simply looking visually appealing.",
      "Complex fintech and membership features can be made easier to understand through strong visual hierarchy, product mockups, and simple user flows.",
      "Giving important product differentiators such as NFC and EURC dedicated visual sections helps users understand their value faster.",
      "Designing for multiple audiences requires clear content grouping and dedicated experiences for each user type.",
      "Strong visual storytelling can make a technical digital platform feel more approachable, trustworthy, and easier to understand.",
    ],
    ...
    /* ---------------- ASSETS ---------------- */
    assets: {
      banner: ["clubcash/b1.png", "clubcash/b2.png"],
  ...
  // period and pregnancy app

  {
    id: 199,
    title: "She Flow – Period & Pregnancy Tracking App",
    category: "UI/UX",
    role: ["UI/UX Designer"],
    ...
    /* ---------------- OVERVIEW ---------------- */
    overview:
      "She Flow is a modern period and pregnancy tracking mobile app designed to help women understand and manage their health journey. The UI/UX design focuses on cycle tracking, pregnancy guidance, health insights, smart reminders, and personalized wellness experiences through a clean, intuitive, and approachable mobile interface.",

    /* ---------------- ABOUT ---------------- */
    about:
      "She Flow combines period tracking, pregnancy tracking, health insights, reminders, and wellness tools into one simple mobile experience. The app helps users track their menstrual cycles, understand fertility windows, follow pregnancy progress, monitor symptoms and moods, and stay informed about important health-related dates. The design was created with a strong focus on usability, accessibility, privacy, and a supportive experience for every stage of the user's journey.",

    /* ---------------- PROBLEM / SOLUTION ---------------- */
    problem_solution: [
      {
        problem:
          "Users need a simple and clear way to understand their menstrual cycle without navigating through complicated health information.",
        solution:
          "Designed a visually clear cycle dashboard with an intuitive circular calendar, period days, ovulation indicators, fertility window, and upcoming cycle information.",
      },

      {
        problem:
          "Period tracking, pregnancy tracking, and health-related features can feel disconnected when presented through separate experiences.",
        solution:
          "Created a unified navigation and feature structure that brings Period Tracking, Pregnancy Tracking, Health Insights, and Smart Reminders into one cohesive experience.",
      },

      {
        problem:
          "Users need quick access to important health information such as symptoms, mood, hydration, exercise, nutrition, and cycle updates.",
        solution:
          "Designed personalized health insight cards and quick-action sections that allow users to record and review important wellness information with minimal effort.",
      },

      {
        problem:
          "Pregnancy-related information can be overwhelming when users have to search through multiple screens to understand their current stage.",
        solution:
          "Created a week-by-week pregnancy tracking experience with organized information, progress indicators, helpful guidance, and easy navigation.",
      },

      {
        problem:
          "Important cycle dates and health activities can easily be forgotten during a busy routine.",
        solution:
          "Introduced Smart Reminders and personalized notifications to help users stay updated about periods, pregnancy milestones, health activities, and other important dates.",
      },

      {
        problem:
          "Health tracking apps need to feel trustworthy and private because users are managing highly personal information.",
        solution:
          "Used a soft, calming visual language with clear privacy messaging, secure-data communication, and a friendly interface designed to build user confidence.",
      },
    ],

    /* ---------------- LESSONS LEARNED ---------------- */
    lesson_learned: [
      "Clear visual hierarchy makes health information easier to understand and navigate.",
      "Personalized tracking experiences can make users feel more connected to their health journey.",
      "Consistent components, spacing, typography, and iconography create a trustworthy mobile experience.",
      "Combining period, pregnancy, and wellness features into a unified experience reduces navigation complexity.",
      "Interactive prototyping helps validate important tracking flows and user interactions before development.",
      "Privacy-focused design is essential when creating products that handle personal health information.",
    ],

    /* ---------------- FIGMA ---------------- */
    figma_link:
      "https://www.figma.com/design/RbPzO88q0jNsSFSbt6fou8/she-flow?node-id=2010-10&t=HWEQrPqiZW8Wd5fZ-1" /* ---------------- ASSETS ---------------- */,
    assets: {
      banner: ["sheflow/b1.png", "sheflow/b2.png"],
...

  {
    ...
    custom_compare: {
      before: {
        heading: (
          <>
            Before – Outdated Interface & <br /> Complicated User Flow
          </>
        ),
      ...
      after: {
        heading:
          "After – Modern, Clean & Productivity-Focused Mobile Experience",
    ...
    /* ---------------- ASSETS ---------------- */
    assets: {
      banner: ["pdf scanner/b1.png", "pdf scanner/b2.png"],
...

  {
    ...
    custom_compare: {
      ...
      after: {
        heading:
          "After – Simple, User-Friendly & Conversion-Focused Experience",
        img: "pawsona/s1.jpg",
      },
    },
    ...
    /* ---------------- ASSETS ---------------- */
    assets: {
      banner: ["pawsona/b1.png", "pawsona/b2.png"],
  ...
  // notepad
  {
    ...
    tools_used: ["Figma", "FigJam", "Sketch", "Google Forms", "Canva"],
    ...
    problem_solution: [
      {
        problem:
          "Users struggle with disorganized notes and poor categorization in the existing app.",
        solution:
          "Introduced folder-based structure with tags and quick filters for better note organization.",
      },
      {
        problem:
          "Writing interface is cluttered and distracts users from note-taking.",
        solution:
    ...
    prototyping: {
      sketch: ["notepad/s.jpeg"],

      wireframe_prototype: ["notepad/p.png"],

      final_ui: ["notepad/s1.png"],
    },
    ...
    figma_link:
      "https://www.figma.com/design/wMTk2VxUBILWR1i2ZmyF8w/NotePad-Task?node-id=0-1&t=3YPDJAwlreeITrkF-1",
    ...
    assets: {
      ...
      ui_images: ["notepad/s1.png", "notepad/s2.png", "notepad/s3.png"],
    },
...

  {
    ...
    problem_solution: [
      ...
      {
        problem: "Buying and selling flow is too complex and slow.",
        solution:
    ...
    prototyping: {
      ...
      wireframe_prototype: ["cards/p.png"],

      final_ui: ["cards/s1.png"],
    },
    ...
    figma_link:
      "https://www.figma.com/design/itQHFSzNz5cWMVhMOIbgkQ/ProxySmith-Website-Design?node-id=0-1&t=qyE4WeSdMO0h5o1s-1",

    assets: {
      banner: ["cards/b1.png", "cards/b2.png", "cards/b3.png", "cards/b4.png"],
      ui_images: ["cards/s1.png", "cards/s2.png", "cards/s3.png"],
    },
...

  {
    ...
    prototyping: {
      ...
      sketch: ["bulkbuyme/sketch.png"],

      wireframe_prototype: ["bulkbuyme/wireframe.png"],

      final_ui: ["bulkbuyme/final.png"],
    },
    ...
    /* ---------------- ASSETS ---------------- */
    assets: {
      banner: ["bulkbuyme/b1.png", "bulkbuyme/b2.png", "bulkbuyme/b3.png"],

      ui_images: ["bulkbuyme/s2.png", "bulkbuyme/s3.png", "bulkbuyme/s4.png"],
    },
...

  {
    ...
    tools_used: ["Figma", "FigJam", "Google Forms", "Miro", "Zoom"],
    ...
    custom_compare: {
      before: {
        heading:
          "Before – Inconsistent Branding & Unstructured Homepage Experience",
        img: "skylarks/before.png",
      },
      after: {
        heading:
          "After – Purple-Aligned Brand Identity with Structured Conversion Flow",
        img: "skylarks/s1.png",
      },
    },
    ...
    assets: {
      ...
      ui_images: ["skylarks/s1.png", "skylarks/s2.png", "skylarks/s3.png"],
    },
...

  {
    ...
    custom_compare: {
      ...
      after: {
        heading:
          "After – Clean Medical-Grade UI with Strong Trust & Product Focus",
    ...
    figma_link:
      "https://www.figma.com/design/7g8ZOjtO0cavKByaaAOZsT/Code-trail-developers?node-id=0-1&t=HORmfu73PfLuiLbD-1",
  ...
  // cow project
  {
    ...
    figma_link:
      "https://www.figma.com/design/UdcvrUrnduV6EM7OLGYPrV/Cow-Proj?node-id=191-40&t=XK4DmVQfDSeCB3qt-1",

    assets: {
      banner: ["cow/b1.png", "cow/b2.png", "cow/b3.png"],
      ui_images: [
        "cow/s1.png",
        "cow/s2.png",
        "cow/s3.png",
...

  {
    ...
    github_link:
      "https://github.com/summyia-fatima/AI-Gmail-Automation-Desktop-Application",
    ...
    assets: {
      banner: ["email/b1.jpg", "email/b3.png"],
      ui_images: [
        "email/s1.png",
        "email/s2.png",
        "email/b2.png",
...

  {
    ...
    assets: {
      banner: ["qmulate/b1.jpg", "qmulate/b2.png"],
